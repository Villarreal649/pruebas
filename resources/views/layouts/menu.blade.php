<li class="side-menus {{ Request::is('*') ? 'active' : '' }}">
    ...
    <i class="fas fa-briefcase"></i></i><span>Plantas</span>
    ...
    <i class="fas fa-clipboard-list"></i><span>Resguardos</span>
    ...
    <i class="fas fa-exchange-alt"></i><span>Tipo de Altas</span>

    </a>
    <a class="nav-link" href="/estados">
    <i class="fas fa-folder"></i><span>Estados</span>
    ...
    <i class="fas fa-book-open"></i><span>Modelos</span>

    </a>
    <a class="nav-link" href="/productos">
    <i class="fas fa-shopping-bag"></i></i><span>Productos</span>
